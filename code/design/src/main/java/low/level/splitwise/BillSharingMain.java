...
import low.level.splitwise.service.ExpenseService;
import low.level.splitwise.service.UserService;
...
public class BillSharingMain {
    ...
    public static void main(String[] args) throws ContributionExceededException, InvalidExpenseException, ExpenseSettledException {
        ...
        } catch (ExpenseDoesNotExistException expenseDoesNotExistsException) {
    ...
    private static void contributeToExpense(String expenseId, String userId) throws ContributionExceededException, InvalidExpenseException, ExpenseSettledException {
